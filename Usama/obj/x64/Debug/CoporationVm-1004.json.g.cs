// This is a system generated file (G2). It reflects the Starcounter App Template defined in the file "CoporationVm.json"
// Version: 1004
...
namespace Usama {
using __Coporati1__ = global::Usama.CoporationVm.JsonByExample;
using _ScTemplate_ = Starcounter.Templates.Template;
using st = Starcounter.Templates;
using s = Starcounter;
using __CoAdd__ = global::Usama.CoporationVm.Input.Add;
using __CoSave__ = global::Usama.CoporationVm.Input.Save;
using __CoName__ = global::Usama.CoporationVm.Input.Name;
using __CoHtml__ = global::Usama.CoporationVm.Input.Html;
using __Coporati2__ = global::Usama.CoporationVm.Input;
using _GEN2_ = System.CodeDom.Compiler.GeneratedCodeAttribute;
using __TLong__ = global::Starcounter.Templates.TLong;
using __TString__ = global::Starcounter.Templates.TString;
using __CoSchema__ = global::Usama.CoporationVm.JsonByExample.Schema;
using __Json1__ = global::Starcounter.Json.JsonByExample;
using __TObject__ = global::Starcounter.Templates.TObject;
using __Json__ = global::Starcounter.Json;
using __Coporati__ = global::Usama.CoporationVm;
using _GEN1_ = System.Diagnostics.DebuggerNonUserCodeAttribute;

#line hidden
[_GEN1_][_GEN2_("Starcounter","2.0")]
public class CoporationVm_json : s::TemplateAttribute {
}
#line default

#line hidden
public partial class CoporationVm : __Json__ {
    #line hidden
    ...
    public CoporationVm() { }
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    public CoporationVm(__CoSchema__ template) { Template = template; }
    [_GEN1_][_GEN2_("Starcounter","2.0")]
    ...
    public static class JsonByExample {
        ...
        public class Schema : __TObject__ {
            public Schema()
                ...
                Save.AddHandler((Json pup, Property<Int64> prop, Int64 value) => { return (new Input.Save() { App = (CoporationVm)pup, Template = (TLong)prop, Value = value }); }, (Json pup, Starcounter.Input<Int64> input) => { ((CoporationVm)pup).Handle((Input.Save)input); });
